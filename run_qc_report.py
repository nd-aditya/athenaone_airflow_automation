...
TABLE_IDENTIFIER_MAP = {
    ...
    "ALLERGY": {"col": "CHARTID"},
    "APPOINTMENT": {"col": "PATIENTID"},
    "APPOINTMENTVIEW": {"col": "PATIENTID"},
    "CHART": {"col": "CHARTID"},
    "CHARTQUESTIONNAIRE": {"col": "CLINICALENCOUNTERID"},
    "CLINICALENCOUNTER": {"col": "CLINICALENCOUNTERID"},
    "CLINICALENCOUNTERDATA": {"col": "CLINICALENCOUNTERID"},
    "CLINICALENCOUNTERDIAGNOSIS": {"col": "CLINICALENCOUNTERID"},
    "CLINICALENCOUNTERPREPNOTE": {"col": "CLINICALENCOUNTERID"},
    ...
    "CLINICALSERVICE": {"col": "CLINICALENCOUNTERID"},
    "CLINICALTEMPLATE": {"col": "CLINICALENCOUNTERID"},
    ...
    "SOCIALHXFORMRESPONSE": {"col": "CLINICALENCOUNTERID"},
    "SOCIALHXFORMRESPONSEANSWER": {
        "chain": [("SOCIALHXFORMRESPONSE", "SOCIALHXFORMRESPONSEID"), ("DOCUMENT", "DOCUMENTID")],
        "col": "CHARTID",
    },
    "VISIT": {"col": "PATIENTID"},
    "VITALSIGN": {"col": "CLINICALENCOUNTERID"},
    "VITALATTRIBUTEREADING": {"col": "CLINICALENCOUNTERID"},
}
