    ...
    def post(self, request, client_id: int, dump_id: int):
        ...
        try:
            ...
            for table_obj in tables_obj:
                table_obj.gcp.cloud_uploaded = Status.IN_PROGRESS
                table_obj.gcp.save()
            ...
            return Response(
                {
                    "message": f"GCP movement for the Tables started successfully",
                    "success": True,
                    "successfull_tables": pushed_tables
                },
        ...
        try:
            ...
            for table_obj in tables_obj:
                response_json.append({
                    'table_id': table_obj.id,
                    'gcp_result': table_obj.gcp.failure_remarks,
                    'gcp_stats': table_obj.gcp.cloud_uploaded
                })
